...
export function InstallPrompt() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-[calc(4.75rem+env(safe-area-inset-bottom))] z-[60] p-3 md:bottom-0 md:p-4 md:pb-[max(1rem,env(safe-area-inset-bottom))]">
