...
export function InstallPrompt() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[60] p-4 pb-[max(1rem,env(safe-area-inset-bottom))] pointer-events-none">
      <div className="pointer-events-auto mx-auto flex max-w-lg gap-3 rounded-2xl border border-border bg-surface p-4 shadow-[0_20px_50px_-18px_rgba(47,29,45,0.55)]">
        ...
        <button
          type="button"
          onClick={dismiss}
          className="h-8 w-8 shrink-0 rounded-full text-muted hover:bg-background"
          aria-label="Cerrar"
        >
